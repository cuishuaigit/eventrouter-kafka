...
func ManufactureSink() (e EventSinkInterface) {
	...
	case "http":
		...
		return h
	case "kafka":
		viper.SetDefault("kafkaBrokers", []string{"kafka-0.kafka-svc.kafka.svc.cluster.local:9092","kafka-1.kafka-svc.kafka.svc.cluster.local:9092","kafka-2.kafka-svc.kafka.svc.cluster.local:9092"})
